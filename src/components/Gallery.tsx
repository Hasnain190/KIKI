...
export default function Gallery() {
  ...
  const images = [
    {
      src: "/images/g1.jpg",
      title: "One last chill night before we become long distance siblings❤️‍🩹🥹",
      category: "Life",
    },
    {
      src: "/images/g2.jpg",
      title:
        "If someone offered you a box containing everything you ever lost, What would you look for first??❤️‍🩹",
      category: "Care",
    },
    { src: "/images/g3.jpg", title: "🩷", category: "Joy" },
    {
      src: "/images/g4.jpg",
      title:
        "Sometimes healing doesn't come from medicine, but from the friend who listens and understands without judgment❤️",
      category: "Life",
    },
    { src: "/images/g5.jpg", title: "🍁", category: "Care" },
    { src: "/images/g6.jpg", title: "❤️‍🩹", category: "Joy" },
  ];
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16 space-y-4">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            are the one we spend with our siblings
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <Link href={"/gallary"}>
            <button className="group inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
