          ...
          <div className="max-w-3xl mx-auto text-center mb-12 md:mb-16 space-y-4">
            ...
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto">
              ...
              <span className="text-gray-800 font-medium">
                {" "}
                food, walks, thoughts, and behind-the-scenes.
              </span>
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-6 md:p-10 mb-8 border border-gray-100">
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-4">
                  Every day is a collection of small, meaningful moments waiting
                  to be captured and shared. Through my lens, I bring you into
                  my world — a world where the ordinary becomes extraordinary,
                  where a simple meal tells a story, and where every walk brings
                  new discoveries.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  My journey as a content creator began with a simple desire to
                  document life's beauty. What started as personal memories has
                  grown into a community of people who appreciate the authentic,
                  the honest, and the whimsical moments that make life special.
                </p>
              </div>
              ...
              {[
                {
                  ...
                  alt: "Daily moments and food",
                  label: "Daily Life",
                },
                {
                  src: "/images/about2.jpg",
                  alt: "Walks and adventures",
                  label: "Adventures",
                },
                {
            ...
            <div className="mt-12 bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 rounded-3xl p-8 md:p-12 text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-xl mx-auto">
                Join me on this journey and be part of a community that
                celebrates life's everyday magic.
              </p>
